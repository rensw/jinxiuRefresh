package com.jinxiu.refresh.custom;
 ...
 */
public class AndroidVsIosHeaderView extends PullHead {
    ...
    public AndroidVsIosHeaderView(Context context) {
        super(context);
        inflate(context, R.layout.layout_custom_refresh_header_view, this);
    ...
    public void onDownBefore(int scrollY) {
        ivVs.setRotationY(scrollY / (float) mHeight * 360);
